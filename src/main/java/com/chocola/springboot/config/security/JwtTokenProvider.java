package com.chocola.springboot.config.security;
...
public class JwtTokenProvider {
    ...
    protected void init() {
        ...
        log.info("secretKey before encoding = {}", secretKey);
        secretKey = Base64.getEncoder().encodeToString(secretKey.getBytes(StandardCharsets.UTF_8));
        log.info("secretKey after encoding = {}", secretKey);
    ...
    public String getUsername(String token) {
        ...
        log.info("[getUsername] 토큰 기반 회원 구별 정보 추출 완료, subject : {}", subject);
        return subject;
    }
